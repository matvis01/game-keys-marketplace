      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="px-4 pb-2 pt-5 sm:px-12 md:flex md:items-center md:justify-between">
         ...
         lg:text-4xl lg:leading-normal"
          ...
          <div className="mx-auto flex w-fit flex-col items-center gap-1 sm:flex-row sm:gap-0">
            <input
              type="text"
              placeholder="Enter your email"
              className="input input-bordered input-sm sm:input-md sm:mr-1 sm:w-72 lg:mb-0"
            />
            <button className="btn btn-primary btn-sm w-full text-white sm:btn-md sm:w-32">
              Sign up
            </button>
          </div>
        </div>
